...
const Hero: React.FC = () => {
  return (
    ...
    //   <div className="bg-gradient-to-b from-[#FF6B35] via-[#FF8C42] to-[#FFF1E6] dark:via-[#E85D2A] dark:to-black/10 overflow-hidden relative">
      ...
      <div className="absolute top-0 z-[999] flex h-full w-full flex-col items-center justify-center gap-y-3">
        <div className="mx-auto flex flex-col items-center justify-center gap-y-6 px-4 text-white lg:w-[70%] 2xl:w-[50%]">
          ...
          <h2 className="text-center text-2xl font-bold  uppercase md:text-5xl">
            Technology For a Brighter{" "}
            <span className="text-primary">Future</span>
          </h2>
          <p className="mx-auto text-center text-[.8rem] md:w-[60%] md:text-base">
            Make the most of your online presence with{" "}
            <span className="text-primary font-bold">BackLog Solution</span> ,
            the ideal solution for operation your business
          </p>
          <Link
            href="/contact"
