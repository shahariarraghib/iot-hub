      ...
      <div className="container max-w-8xl mx-auto px-5 2xl:px-0">
        <div className="flex justify-between md:items-end items-start mb-10 md:flex-row flex-col">
          <div>
            ...
            <h2 className="lg:text-40 text-40 font-medium dark:text-white">
              IoT Hub: Transforming Connectivity into Smarter Solutions
            </h2>
            <p className="text-dark/50 dark:text-white/50 text-xm">
              Stay ahead with the latest trends, insights, and innovations in
              the Internet of Things.
            </p>
          </div>
          <Link
            href="/blogs"
            className="bg-primary dark:bg-white text-white dark:text-dark py-4 px-8 rounded-full hover:bg-dark duration-300 dark:hover:bg-dark dark:hover:text-white hover:text-white font-semibold mt-6 md:mt-0 inline-block"
